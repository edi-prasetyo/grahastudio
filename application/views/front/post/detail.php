...
<head>
    ...
    <meta property="og:url" content="<?php echo base_url('post/detail/' . $post->post_slug); ?>" />
            ...
            <div class="container">
                <div class="col-md-10 mx-auto">
                    <ul class="breadcrumb my-3">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('post') ?>"> Blog</a></li>
                ...
                <div class="post-header py-3">
                    <div class="d-flex">
                        <div class="img-avatar ">
                            <img width="20%" class="img-fluid me-3" src="<?php echo base_url('assets/img/avatars/' . $post->user_image); ?>">
                        </div>
                        <span class="me-5 my-auto"><?php echo $post->user_name; ?></span>
                        <span class="border-end ms-2"></span>
                        <span class="ms-3 my-auto">Posted <?php echo date('j, F Y', strtotime($post->created_at)); ?>
                    </div>
                </div>



                <img class="img-fluid rounded" src="<?php echo base_url('assets/img/post/' . $post->post_image); ?>">
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            <div class="card-body">
                                ...
                                <div class="lh-lg fs-4">
                                    <?php echo $post->post_description; ?>

                                    <span class="badge bg-light-primary text-primary"><?php echo $post->category_name; ?></span>
                                    <span class="badge bg-light-primary text-primary"> <?php echo $post->post_views; ?> Views</span>
                                </div>
