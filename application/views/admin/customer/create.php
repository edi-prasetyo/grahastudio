<div class="col-md-7 mx-auto">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php echo form_open('admin/customer/create', array('class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="whatsapp" placeholder="Nomor Handphone Atau Whatsapp" value="<?php echo set_value('whatsapp'); ?>" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="phone" value="<?php echo set_value('phone'); ?>" placeholder=" Telepon">
                ...
                <div class="col-md-6 my-3">
                    <div class="form-group">
                        <button type="submit" name="submit" class="btn btn-primary btn-lg"><i class="fa fa-save"></i> Simpan Data</button>
                    </div>
                </div>
            </div>
