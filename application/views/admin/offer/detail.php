                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-6 col-md-12 col-12">
                                <div class="mb-2">
                                    <!-- content  -->
                                    <p class="text-muted mb-0">ID-<?php echo $offer->id_offer; ?></p>
                                    <h3 class="mt-2 mb-3 fw-bold"><?php echo $offer->name; ?></h3>
                                    <i class="fa-solid fa-calendar"></i> <?php echo date('j M Y', strtotime($offer->created_at)); ?>
                                </div>
                            </div>
                            <!-- col  -->
                            <div class="col-xl-5 col-lg-6 col-md-12 col-12">
                                ...
                                <div>
                                    <div class="text-success">
                                        <?php echo $offer->business_fields; ?>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                          ...
                          justify-content-lg-end">
                                <!-- text  -->
                                <div class="mb-2">
                                    <p class="mb-1">E-mail: <a href="#"><?php echo $offer->email; ?></a></p>
                                    <p class="mb-1">Phone: <?php echo $offer->whatsapp; ?></p>
